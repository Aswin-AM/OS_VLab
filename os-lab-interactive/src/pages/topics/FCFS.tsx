...
const FCFS = () => {
  ...
  const runSimulation = () => {
    ...
    sorted.forEach((p) => {
      ...
      ganttChart.push({ pid: p.id, start: startTime, end: endTime });

      waitingTimes[p.id] = startTime - p.arrival;
      turnaroundTimes[p.id] = endTime - p.arrival;
  ...
  return (
    <div className="min-h-screen py-12">
      <div className="container max-w-7xl">
        {/* Header */}
        <div className="mb-8">
          <h1 className="mb-2 text-4xl font-bold">FCFS - First Come First Serve</h1>
