...
const PriorityNPVisualizer: React.FC = () => {
  ...
  return (
    <div className="priority-visualizer-container">
      <h2>Non-Preemptive Priority Visualizer</h2>
      ...
      <button onClick={calculatePriorityNP}>Calculate Non-Preemptive Priority Schedule</button>
...
export default PriorityNPVisualizer;
